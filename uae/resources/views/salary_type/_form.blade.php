			  ...
			  <div class="form-group">
				...
				{!! Form::select('salary_type', [null=>'Please Select','earning' => 'Earning','deduction' => 'Deduction'],isset($salary_type->salary_type) ? $salary_type->salary_type : '',['class'=>'form-control select2','id'=>'select24','placeholder'=>'Select Type'])!!}
			  </div>
			  <div class="form-group">
