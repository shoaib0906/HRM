		...
		<div class="tab-pane animated fadeInRight" id="sms">
						    ...
						    <div class="panel panel-success">
			                    ...
			                    <div class="panel-body">
									 <form action="{{url('training_update')}}" method="post">
										<div class="box-info">
											<h2><strong>Training </strong> Update
											...
											<div class="form-group">
									            <input type="text" name="training_name" value="{{$training[0]->training_name}}" class="form-control">
									            <input type="hidden" name="id"  value="{{$training[0]->id}}" class="form-control">
									        </div>
