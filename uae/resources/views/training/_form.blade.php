			  ...
			  <div class="form-group">
			    ...
			    {!! Form::select('leave_type_id', [''=>''] + $leave_types, isset($leave->leave_type_id) ? $leave->leave_type_id : '',['class'=>'form-control select2','id'=>'select22','placeholder'=>'Select Training Name'])!!}
			  	
			  </div>
			  <div class="form-group">
			    {!! Form::label('from_date',trans('messages.From Date'),[])!!}
				{!! Form::input('text','from_date',isset($leave->from_date) ? $leave->from_date : '',['class'=>'form-control datepicker-input','id'=>'rangepicker4','placeholder'=>'Enter From Date','readonly' => 'true'])!!}
			  </div>
			  <div class="form-group">
			    {!! Form::label('to_date',trans('messages.To Date'),[])!!}
				{!! Form::input('text','to_date',isset($leave->to_date) ? $leave->to_date : '',['class'=>'form-control ','id'=>'datetime1','placeholder'=>'Enter To Date'])!!}
			  </div>
			   <div class="form-group">
