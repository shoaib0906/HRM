			<div class="col-sm-6">
			  ...
			  <div class="form-group">
				...
				{!! Form::select('country_id', [null=>'Please Select'] + $countries,config('config.country_id'),['class'=>'form-control select2','id'=>'select24','placeholder'=>'Select Company'])!!}
			...
			<div class="col-sm-6">
			  ...
			  <div class="form-group">
				...
				{!! Form::select('finance_ymonth', [null=>'Select Month',1=>'January',2=>'February',3=>'March',4=>'April',5=>'May',6=>'June',7=>'July',8=>'August',9=>'September',10=>'October',11=>'November',12=>'December'],config('config.finance_ymonth'),['class'=>'form-control  select2','id'=>'select21','placeholder'=>'Select Month'])!!}
			  </div>
              <div class="form-group">

			    {!! Form::label('timezone_id',trans('messages.Timezone'),[])!!}

				{!! Form::select('timezone_id', [null=>'Please Select'] + $timezones,config('config.timezone_id'),['class'=>'form-control  select2','id'=>'select22','placeholder'=>'Select Timezone'])!!}
			  ...
			  <div class="form-group">
				...
				{!! Form::select('default_language', [null=>'Please Select'] + $languages,(config('config.default_language')) ?  : 'en',['class'=>'form-control select2','id'=>'select23','placeholder'=>'Select Language'])!!}
			  ...
			  <div class="form-group">
				...
				{!! Form::select('direction', ['ltr'=>'Left to Right',
					...
					'rtl' => 'Right to Left'],config('config.direction'),['class'=>'form-control select2','id'=>'select24','placeholder'=>'Select Timezone'])!!}
