				...
				<div class="box-info">
					...
					<div class="tabs-left row">	
						...
						<ul class="nav nav-tabs col-md-2" style="padding-right:0;">
                          ...
                          <li><a href="#asset" data-toggle="tab"><span class="fa fa-file"></span> {!! trans('messages.Assets') !!}</a></li>
                          ...
                          <li><a href="#alias" data-toggle="tab"><span class="fa fa-building"></span> {!! trans('messages.Alias') !!}</a></li>
														...
														<tbody>
															@foreach($assets_types as $asset)
																<tr>
																	...
																	<td>
																		<a href="{!! URL::to('/asset/'.$asset->id.'/edit') !!}" class='btn btn-xs btn-default' data-toggle='modal' data-target='#myModal' > <i class='fa fa-edit'></i> Edit</a>
