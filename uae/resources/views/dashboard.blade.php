@extends('admin.layouts.default')
	...
	@section('content')
            ...
            <div class="col-sm-3 col-xs-6">
				<div class="box-info">
					...
					<div class="text-box">
						<h3>{!! $expire_count !!}</h3>
                        @if($expire_count)
                        <p><a href="{!! URL::to('/expirelist') !!}">{!! trans('messages.Expire List') !!}</a></p>
                        @else
              ...
              <div class="row">
				...
				<div class="box-info">
					...
					<div class="notice-widget" >
						...
						<p class="alert alert-info"><strong>{!! Auth::user()->first_name.' '.Auth::user()->last_name.', You have '.$child_staff_count !!} staff under your designation.

						</strong></p>

						<h4><strong>You : {!! Auth::user()->Designation->designation.' ('.Auth::user()->Designation->Department->department_name.')' !!}
        ...
        <!--<div class="row">
            <!--<iframe src="https://calendar.google.com/calendar/embed?src=shoabcse.ru%40gmail.com&ctz=Asia/Dhaka" style="border: 0" width="800" height="600" frameborder="0" scrolling="no"></iframe>
        </div>-->
