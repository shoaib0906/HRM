			  ...
			  <div class="form-group">
				...
				{!! Form::input('text','start_date',isset($task->start_date) ? $task->start_date : '',['class'=>'form-control ','id'=>'rangepicker4','placeholder'=>'Enter Start Date','readonly' => 'true'])!!}
			  </div>
			  <div class="form-group">
			    {!! Form::label('due_date',trans('messages.Due Date'),[])!!}
				{!! Form::input('date','due_date',isset($task->due_date) ? $task->due_date : '',['class'=>'form-control ','id'=>'rangepicker5','placeholder'=>'Enter Due Date'])!!}
			  </div>
			  <div class="form-group">
			  ...
			  <div class="form-group">
			    ...
			    {!! Form::select('user_id[]', $users, isset($selected_user) ? $selected_user : '',['class'=>'form-control input-xlarge select2','id'=>'selectize-tags2','placeholder'=>'Select User','multiple' => true])!!}
			  </div>
