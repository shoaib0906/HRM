			  ...
			  <div class="form-group">
				...
				{!! Form::select('designation_id', [''=>''] + $designations,isset($job->designation_id) ? $job->designation_id : '',['class'=>'form-control input-xlarge select2','id'=>'select21','placeholder'=>'Select Designation'])!!}
			  </div>
			  <div class="form-group">
			  ...
			  <div class="form-group">
			    ...
			    {!! Form::textarea('job_description',isset($job->job_description) ? $job->job_description : '',['size' => '30x3', 'class' => 'form-control summernote-small', 'id'=>'summernote', 'placeholder' => 'Enter Description'])!!}
			  </div>
