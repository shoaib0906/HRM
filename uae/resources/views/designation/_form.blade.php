			  ...
			  <div class="form-group">
				...
				{!! Form::select('department_id', [''=>''] + $departments,isset($designation->department_id) ? $designation->department_id : '',['class'=>'form-control select2','id'=>'select24','placeholder'=>'Select Department'])!!}
			  </div>
			  <div class="form-group">
			    {!! Form::label('top_designation_id',trans('messages.Top Designation'),[])!!}
				{!! Form::select('top_designation_id', [''=>''] + $top_designations,isset($designation->top_designation_id) ? $designation->top_designation_id : '',['class'=>'form-control  select2','id'=>'select25','placeholder'=>'Select Top Designation'])!!}
			  </div>
			  <div class="form-group">
