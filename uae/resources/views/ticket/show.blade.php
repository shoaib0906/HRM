				...
				<div class="panel panel-primary filterable">
						<div class="panel-heading clearfix  ">
                                <div class="panel-title pull-left">
                                       <div class="caption">
                                    <i class="livicon" data-name="bookmark" data-size="16" data-loop="true" data-c="#fff" data-hc="white"></i>
                                     Ticket Details
                                </div>
                                </div>
                            </div>
					...
					<div class="  col-sm-4">
						<div class="box-info text-center user-profile-2">
							...
							<h5>({!!$ticket->User->Designation->designation." in ".$ticket->User->Designation->Department->department_name !!} Dept)</h5>
							<ul class="list-group">
