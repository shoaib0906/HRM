			  ...
			  <div class="form-group">
			    ...
			    {!! Form::select('expense_head_id', [''=>''] + ($expense_heads), isset($expense->expense_head_id) ? $expense->expense_head_id : '',['class'=>'form-control  select2','id'=>'select21','placeholder'=>'Select Expense Head'])!!}
			  </div>
			  <div class="form-group">
			    {!! Form::label('expense_date',trans('messages.Expense Date'),[])!!}
				{!! Form::input('text','expense_date',isset($expense->expense_date) ? $expense->expense_date : '',['class'=>'form-control','id'=>'rangepicker4','placeholder'=>'Enter Expense Date','readonly' => 'true'])!!}
			  </div>
			  <div class="form-group">
