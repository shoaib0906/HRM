		...
		<div class="tab-pane animated fadeInRight" id="sms">
						    ...
						    <div class="panel panel-success">
						    	<div class="panel-heading">
			                        <h3 class="panel-title">
										...
										{!! trans('messages.Send SMS to') !!}  {!! ucfirst($type_detail) !!}
			                        </h3>
			                    </div>
							...
							{!! Form::open(['route' => 'sms.store','role' => 'form', 'class'=>'sms-form']) !!}
											  ...
											  <div class="form-group">
												...
												{!! Form::select('receivers', $receivers,'',['class'=>'form-control select2','id'=>'selectize-tags2','placeholder'=>'Select','multiple' => 'true'])!!}
											  </div>
											  <div class="form-group">
