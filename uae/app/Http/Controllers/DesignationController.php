...
Class DesignationController extends Controller{
	...
	public function index(Designation $designation){
		...
		foreach ($designations as $designation){
			...
			$cols = array(
					...
					'<a href="/designation/'.$designation->id.'/delete" class="btn btn-default btn-xs" data-toggle="tooltip" title="Delete"> <i class="fa fa-trash"></i></a> '.
					'</div>',
	...
	public function destroy($id,Designation $designation){
