...
Class NoticeController extends Controller{
	...
	public function index(Notice $notice){
        ...
        foreach($notices as $notice){
			...
			$cols = array(
				'<div class="btn-group btn-group-xs"><a href="notice/'.$notice->id.'/edit" class="btn btn-default" data-toggle="tooltip" title="Edit"> <i class="fa fa-edit"></i></a> '.
				'<a href="notice/'.$notice->id.'/delete" class="btn btn-default" data-toggle="tooltip" title="Delete"> <i class="fa fa-trash"></i></a></div>',
				$notice->title,
				$designation_name,
	...
	public function edit(Notice $notice){
		...
		if(!Entrust::can('manage_all_notice') && $notice->username != Auth::user()->username)
			return redirect('/dashboard')->withErrors(config('constants.NA'));
		$notice->from_date = date('m/d/Y', strtotime($notice->from_date));
		$notice->to_date = date('m/d/Y', strtotime($notice->to_date));
	...
	public function store(NoticeRequest $request, Notice $notice){
		...
		$notice->from_date = date('Y-m-d', strtotime( $request->input('from_date')));
		$notice->to_date = date('Y-m-d', strtotime( $request->input('to_date')));
