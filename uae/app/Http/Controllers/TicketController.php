	...
	public function index(Ticket $ticket){
        ...
        foreach($tickets as $ticket){
			...
			$cols = array(
					...
					'<a href="/ticket/'.$ticket->id.'" class="btn btn-default" data-toggle="tooltip" title="View"> <i class="fa fa-check"></i></a> '.
					'<a href="/ticket/'.$ticket->id.'/edit" class="btn btn-default" data-toggle="tooltip" title="Edit"> <i class="fa fa-edit"></i></a> '.
					'<a href="/ticket/'.$ticket->id.'/delete" class="btn btn-default" data-toggle="tooltip" title="Delete"> <i class="fa fa-trash"></i></a> '.'</div>',
					$name,
