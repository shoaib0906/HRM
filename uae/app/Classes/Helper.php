...
use Services_Twilio_RestException;
	...
	Class Helper{
		...
		public static function getAvatarpro($id){
			...
			if(isset($profile->photo))
				...
				echo '<img src="uploads/user/'.$profile->photo.'" class="img-circle pull-left" width="130" alt="riot" data-toggle="tooltip">';
			else
				echo '<img src="uploads/user/569e1321709f5.png" class="img-circle pull-left" width="130" alt="riot" data-toggle="tooltip">';
		...
		public static function getAvatar($id){
			...
			if(isset($profile->photo))
				...
				echo '<img src="uploads/user/'.$profile->photo.'" class="img-circle pull-left" width="35" alt="riot" data-toggle="tooltip">';
			else
				echo '<img src="uploads/user/569e1321709f5.png" class="img-circle pull-left" width="35" alt="riot" data-toggle="tooltip">';

		}

		public static function getAvatar1($id){
			...
			if(isset($profile->photo))
				...
				echo '<img src="uploads/user/'.$profile->photo.'" alt="img"
                                     class="img-circle img-bor">';
            else
            	echo '<img src="uploads/user/569e1321709f5.png" alt="img"
                                     class="img-circle img-bor">';          

			

		}
		public static function getAvatar2($id){
			...
			if(isset($profile->photo))
				...
				echo '<img src="uploads/user/'.$profile->photo.'" class="img-circle img-bor" height="35px" alt="riot" data-toggle="tooltip">';
			else
				echo '<img src="uploads/user/569e1321709f5.png" class="img-circle img-bor" height="35px" alt="riot" data-toggle="tooltip">';
